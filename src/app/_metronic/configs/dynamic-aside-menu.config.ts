export const DynamicAsideMenuConfig = {
  items: [
    ...
    // },
    {
      ...
      root: true,
      icon: 'flaticon2-expand',
      page: '/function-category',
      svg: './assets/media/svg/icons/Communication/Shield-thunder.svg'
    },
    {
      title: 'Function',
      code: 'FUNCTION',
      root: true,
      page: '/function',
      svg: './assets/media/svg/icons/Navigation/Arrow-to-right.svg'
    },
    {
      title: 'Legacy Owner',
      code: 'LEGACY_OWNER',
    ...
    },
    {
      ...
      root: true,
      page: '/legacy-system',
      svg: './assets/media/svg/icons/Food/Cake.svg'
    },
    {
      title: 'Legacy Function',
      code: 'LEGACY_FUNCTION',
      root: true,
      page: '/legacy-function',
