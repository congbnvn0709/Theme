...
import { NotificationsCustomDropdownInnerComponent } from './dropdown-inner/notifications-custom-dropdown-inner/notifications-custom-dropdown-inner.component';
...
@NgModule({
  declarations: [
    ...
    ScrollTopComponent,
    ToolbarComponent,
    NotificationsCustomDropdownInnerComponent,
  ],
